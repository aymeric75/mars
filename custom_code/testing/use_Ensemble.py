...
ob_model = load_order_batch_model("/scratch/project_2012747/mars_runs/order_batch_model/31737330/val=val_loss=1.6047.ckpt", device="cpu")
...
ensemble_model = load_ensemble_model(
    ckpt_path="/scratch/project_2012747/mars_runs/ensemble_model/31731449/ckpt_step=0_val=3.307867.pt", order_vocab_size=49152, device="cpu"
)
