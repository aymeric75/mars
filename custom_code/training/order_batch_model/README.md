...
Best curve in this sweep: `bs=4, lr=1e-4` (`val_loss ~= 1.70`), ahead of `bs=2, lr=1e-4` (`~1.88`). The `bs=8, lr=1e-4` run remained clearly worse (`~3.06`) and also stopped much earlier.
